...
Untuk mendapatkan URL prapetanda bagi pramuat naik fail, panggil titik akhir `<SERVER_URL>/webhook/pre-upload/<SESSION_ID>` menggunakan permintaan `POST`.
...
Ini menunjukkan bahawa pengguna yang memanggil titik akhir mungkin tidak wujud.
