...
const config: Config = {
  ...
  colors: {
    ...
    gray: {
      ...
      ["focus_washed-100"]: "rgb(var(--gray-focus_washed-100) / <alpha-value>)",
    ...
    white: {
      ...
      ["focus_white-100"]: "rgb(var(--white-focus_white-100) / <alpha-value>)",
      ["focus_white-200"]: "rgb(var(--white-focus_white-200) / <alpha-value>)",
